...
export default {
  ...
  methods:{
    ...
    doSave() {this.$axios.post(this.$httpUrl+'/goodstype/save',this.form).then(res=>res.data).then(res=>{
      console.log(res)
      if (res.code==200) {
...
<!--查询-->
      ...
      <el-input v-model="name" placeholder="请输入分类名" suffix-icon="el-icon-search" style="width: 160px;margin-left: 5px;"
                @keyup.enter.native="loadPost">
      </el-input>
